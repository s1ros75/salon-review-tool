...
export default function Home() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 p-4">
        <div className="max-w-2xl mx-auto pt-8">
          <div className="bg-white rounded-2xl shadow-xl p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">口コミ文が生成されました</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              />
              <p className="text-sm text-gray-500 mt-2">内容は編集できます</p>
            </div>

            {formData.rating >= 4 ? (
              <div>
                <p className="text-gray-700 mb-4">この内容でGoogleマップに投稿しますか？</p>
                <button
              ...
              <div>
                <p className="text-gray-700 mb-4">貴重なご意見をありがとうございます。オーナーに送信しますか？</p>
                <button
                  onClick={handleFinalSubmit}
                  disabled={isSubmitting}
            ...
            <button onClick={() => setShowResult(false)} className="w-full mt-4 text-gray-600 hover:text-gray-800 py-2">
              戻る
            </button>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 p-4">
      <div className="max-w-2xl mx-auto pt-8">
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center">ご来店アンケート</h1>
          <p className="text-gray-600 text-center mb-6">ご感想をお聞かせください</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {formData.rating > 0 && <p className="text-center text-gray-600 mt-2">{formData.rating}/5</p>}
            </div>
            ...
            {/* 改善点 */}
            <div>
              <label className="block text-gray-700 font-semibold mb-2">改善点（任意）</label>
              <textarea
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-bold py-4 px-6 rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGenerating ? "生成中..." : "口コミ文を生成"}
            </button>
          </form>
        </div>
      </div>
