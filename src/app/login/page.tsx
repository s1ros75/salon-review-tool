    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <p className="text-xs tracking-widest text-gray-400 uppercase mb-1">Login</p>
          <h1 className="text-2xl font-light text-gray-800 tracking-wide">ログイン</h1>
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          アカウントをお持ちでない方は
          <a href="/register" className="text-gray-600 hover:text-gray-800 ml-1">
            新規登録 ›
          </a>
        </p>
      </div>
